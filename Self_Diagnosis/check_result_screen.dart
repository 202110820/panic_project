                ...
                child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text.rich(
                            TextSpan(children: [
                              TextSpan(text: "공황장애가\n", style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'Inter'),),
                              TextSpan(text: "의심되니 전문가의 상담", style: TextStyle(color: Color(0xFFF82834), fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'Inter'),),
                              TextSpan(text: "을\n받아보시기 바랍니다.\n\n심각한 스트레스를 받은 직후이거나,\n불편한 장소, 긴장의 상태에서 중증\n정도 증상을 빈번하게 겪고 계신다면,\n\n빠른 시일 내에 전문가를\n찾아주시기 바랍니다.",
                                style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'Inter'),)
                                  ...
                                  child: ElevatedButton.icon(
                                    onPressed: (){
                                      Navigator.pushReplacement(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Pd_1(), // Pd_1() 공황장애 설명 페이지로 이동
                                        ),
                                      );
                                    },
                                    icon: Icon(
                ...
                child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text.rich(
                          TextSpan(children: [
                            TextSpan(text: "정상수치", style: TextStyle(color: Color(0xFF1463FC), fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'Inter'),),
