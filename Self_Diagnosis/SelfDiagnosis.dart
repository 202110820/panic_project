...
import 'diagnosis_check.dart'; // 자가진단 페이지
import '../main.dart';
        ...
        home: Scaffold(
            appBar: AppBar(
              ...
              title: Container(
                ...
                child: Text("Self Diagnosis", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w700, shadows:[
            ...
            body: Center(
                child: Column(
                    children: [
                      SizedBox(height: (MediaQuery.of(context).size.height - AppBar().preferredSize.height - MediaQuery.of(context).padding.top) * 0.05 + 25,),
                      Container(
                        child: Container(
                          child: Image(image: AssetImage('assets/doctor.png')), // 의사 사진 추가
