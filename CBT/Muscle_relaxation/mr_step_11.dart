...
import 'mr_step_12.dart';

class Mr_step_11 extends StatelessWidget {
  const Mr_step_11({Key? key}) : super(key: key);
            ...
            body: Column(
              children: [
                ...
                Container(
                  ...
                  child: Image.asset('assets/mstep11.png'),
                  //color: Colors.red
                ),
                ...
                Container(
                    ...
                    child: Center(
                      child: Text("눈을 5초동안 세게 감았다가 뜹니다.\n위 동작을 2회 반복합니다.",
                            ...
                            child: ElevatedButton.icon(
                              onPressed: (){
                                Navigator.push(
                                  context,
                                  PageRouteBuilder(
                                    pageBuilder: (context, animation1, animation2) => Mr_step_12(),
