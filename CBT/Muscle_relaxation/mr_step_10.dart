...
import 'mr_step_11.dart';

class Mr_step_10 extends StatelessWidget {
  const Mr_step_10({Key? key}) : super(key: key);
            ...
            body: Column(
              children: [
                ...
                Container(
                  ...
                  child: Image.asset('assets/mstep10.png'),
                  //color: Colors.red
                ),
                ...
                Container(
                    ...
                    child: Center(
                      child: Text("입꼬리를 귀 쪽으로 끝까지 올린 후,\n근육을 10초간 긴장시킵니다.",
                            ...
                            child: ElevatedButton.icon(
                              onPressed: (){
                                Navigator.push(
                                  context,
                                  PageRouteBuilder(
                                    pageBuilder: (context, animation1, animation2) => Mr_step_11(),
