...
import 'mr_step_6.dart';

class Mr_step_5 extends StatelessWidget {
  const Mr_step_5({Key? key}) : super(key: key);
            ...
            body: Column(
              children: [
                ...
                Container(
                  ...
                  child: Image.asset('assets/mstep5.png'),
                  //color: Colors.red
                ),
                            ...
                            child: ElevatedButton.icon(
                              onPressed: (){
                                Navigator.push(
                                  context,
                                  PageRouteBuilder(
                                    pageBuilder: (context, animation1, animation2) => Mr_step_6(),
