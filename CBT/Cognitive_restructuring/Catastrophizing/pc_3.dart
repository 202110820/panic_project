...
class Pc_3 extends StatelessWidget {
  const Pc_3({Key? key}) : super(key: key);
                ...
                Stack(
                  children:[
                    Container(
                      ...
                      child: Image.asset('assets/o_3.png'),
                      //color:Colors.red
                    ),
                        ...
                        child: Directionality(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: (){
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (_) => Pc_4()),
                                );
                              },
                              icon: Icon(
                                Icons.navigate_before,
