...
String formatDay(DateTime selectedDay) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        // 개인 정보들 표시
          ...
          final widgets = documents.map((DocumentSnapshot document) {
            String sex = document['sex'].toString().toLowerCase();
            String? dropdownValue = document['sex'];
            Timestamp currentDate = document['birth'];
            DateTime changedDate = currentDate.toDate();
            //changedGender = '';
            //_nicknameController.text = document['userID'];
            return Column(
                children: [
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String? value) {
                                  ...
                                  setState(() {
                                    ...
                                    changedGender = dropdownValue.toString();
                                    print("저장값: ${changedGender}");
                                    //document.reference.set({'sex': value,}, SetOptions(merge: true)); // 바뀐 데이터 저장
                                  });
                                },
                                items: Genderlist.map<DropdownMenuItem<String>>((String value) {
                        ...
                        Container(
                          //color: Colors.grey,
                            ...
                            child: Column(children: [
                              ...
                              InkWell(
                                onTap: () async {
                                  DateTime? pickedDate = await _selectDate(context, currentDate);
                                  if (pickedDate != null) {
                                    setState(() {
                                      changedDate = pickedDate;
                                      //tempPickedDate = pickedDate;
                                    });
                                  }
                                },
                                child: Container(
                                  ...
                                  child: Text(
                                    '${(changedDate == null) ? formatSelectedDay(currentDate) : formatDay(changedDate)}', //tempPickedDate ?? document[]
                                    textAlign: TextAlign.right,
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 15,
